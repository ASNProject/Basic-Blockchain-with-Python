...
#Membuat sebuah kelas untuk mempresentasikan sebuah blockchain
class Blockchain:
    def __init__(self):
        self.chain = []
        self.current_transaction = []
        #Membuat metode untuk menghasilkan sebuah blok
...
#################################Tambahan Concesus diatas########################################
    ...
    #Membuat mining blockchain menggunakan hashlib
